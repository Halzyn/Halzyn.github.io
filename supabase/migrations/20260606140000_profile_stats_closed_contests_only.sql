-- Public profile totals and RPG stats must not include ongoing contests. Restrict stats payload
-- to contests past their deadline (same notion as the app’s “closed” contests).
