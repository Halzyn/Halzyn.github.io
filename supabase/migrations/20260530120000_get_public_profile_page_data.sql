-- One round-trip for public profile + contest stats (tracks, submissions, marks).
...
grant execute on function public.get_public_profile_page_data(text) to anon, authenticated;
